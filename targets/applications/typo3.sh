...
curl -c /tmp/cookie -b /tmp/cookie --globoff "http://wvs.localhost/typo3/typo3/install/index.php?mode=123&TYPO3_INSTALL[type]=database&step=5" --data "systemToInstall=Introduction&TYPO3_INSTALL%5Bdatabase_type%5D=import%7CCURRENT_TABLES%2BSTATIC&TYPO3_INSTALL%5Bdatabase_import_all%5D=1"
